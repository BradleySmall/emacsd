;;; sly-named-readtables-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(with-eval-after-load 'sly (add-to-list 'sly-contribs 'sly-named-readtables 'append))

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sly-named-readtables" '("sly-named-readtable")))

;;;***

;;;### (autoloads nil nil ("sly-named-readtables-pkg.el") (0 0 0
;;;;;;  0))
